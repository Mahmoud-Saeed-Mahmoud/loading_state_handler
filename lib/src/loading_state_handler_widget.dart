...
import 'package:loading_state_handler/src/current_state_enum.dart';
...
class _LoadingStateHandlerWidgetState extends State<LoadingStateHandlerWidget> {
  ...
  Widget build(BuildContext context) {
    if (widget.disableWidgetChanges ||
      ...
      if (widget.currentState == CurrentStateEnum.loading) {
      ...
      } else if (widget.currentState == CurrentStateEnum.error) {
      ...
      } else if (widget.currentState == CurrentStateEnum.empty) {
      ...
      } else if (widget.currentState == CurrentStateEnum.normal) {
        return widget.child;
      } else {
        return widget.child;
      }
  ...
  void _applyMethods() {
    ...
    } else if (widget.currentState == CurrentStateEnum.data) {
